...
namespace ErpMaterial.Web.Controllers
{
    ...
    {
        private ISysLogService _serviceSysLog;
        public SysLogController(ISysLogService serviceSysLog)
        {
            _serviceSysLog = serviceSysLog;
        }
        ...
        public JsonResult ListPage()
        {
            ...
            return Json(_serviceSysLog.listPage(page, limit, conditions));
        }
    }
}