...
namespace ErpMaterial.Web.Controllers
{
    ...
    {
        private IMaterialPlanService _serviceMaterialPlan;
        public MaterialPlanController(IMaterialPlanService serviceMaterialPlan)
        {
            _serviceMaterialPlan = serviceMaterialPlan;
        }
        ...
        public JsonResult ListPage()
        {
            ...
            return Json(_serviceMaterialPlan.listPage(page, limit, conditions));
        }
    }
}