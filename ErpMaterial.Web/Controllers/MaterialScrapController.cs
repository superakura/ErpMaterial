...
{
    public class MaterialScrapController : Controller
    {
        private IMaterialScrapService _serviceMaterialScrap;
        public MaterialScrapController(IMaterialScrapService serviceMaterialScrap)
        {
            _serviceMaterialScrap = serviceMaterialScrap;
        }
        ...
        public JsonResult ListPage()
        {
            ...
            return Json(_serviceMaterialScrap.listPage(page, limit, conditions));
        }
    }
}